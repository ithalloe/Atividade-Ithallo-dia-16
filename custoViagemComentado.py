...
#nessa parte é definido os valores das variaveis custo de combustivel total, custo pedagio total  e custo total
...
#aqui é onde o usuario insere as informções, distancia =, custo combustivel,consumo veiculo,numero de pedagio e custo pedagio
...
custo_pedagio)
#aqui é a parte que mostra ao usuario os resultados de custo total, custo combustivel total e custo pedagio total.
